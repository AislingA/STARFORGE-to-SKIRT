...
class SkirtSim:
    ...
    def GasFile(self):
        ...
        self.gas_data = {
            ...
            'y (pc)': coords[r_cut][:, 1],
            'z (pc)': coords[r_cut][:, 2],
            'h (pc)': pt0['SmoothingLength'][r_cut],
            'M (Msun)': pt0['Masses'][r_cut],
            'T (K)': pt0['Temperature'][r_cut]
        }
        #formatting for skirt
