...
def read_snapshot_info(snapshot_path, sim_type='sph'):
    ...
    """
    r_extract = 0.50 # Extraction radius in pc
    snap_head = {}
    pt5 = None
    pt0 = None
        ...
        try:
            with h5py.File(snapshot_path, 'r') as f:
                ...
                snap_head = {
                    ...
                    'Extraction Radius (pc)': (header['BoxSize']) / 10, # instead of r_extract, changing this to the cloud radius so those will be equal to each other
